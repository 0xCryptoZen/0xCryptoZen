...
- 🦞 __[MoveWhisperer](https://github.com/0xCryptoZen/move-whisperer)__ - Generate Claude SKILL.md files from Sui Move smart contracts. [Live Demo](https://move-whisperer.pages.dev)
- 📊 __[Sui RPC Monitor](https://github.com/0xCryptoZen/sui-rpc-monitor)__ - Real-time monitoring tool for Sui blockchain RPC nodes with PostgreSQL backend
- 🛡️ __[DetectSuiHoneyPot](https://github.com/0xCryptoZen/DetectSuiHoneyPot)__ - Rust tool to detect fake tokens and honey pots on Sui
- 🗡️ __[SuiLancet](https://github.com/DolphinsLab/SuiLancet)__ - Lightweight personal tool for managing multiple Sui wallets and backends in one place
- ✨ __[suiz-ai-commit](https://github.com/SuiZProtocol/suiz-ai-commit)__ - Auto generate standard commit by local mode from ollama mistral

---

## What I'm Doing

- 🌍 __Mission__ - Changing the world with AI-native and decentralized technology
...
<img src="https://komarev.com/ghpvc/?username=0xCryptoZen&color=6FBCF0&style=flat-square" alt="Profile views">
